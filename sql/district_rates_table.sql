...
, ("SCH_DISCWDIS_REF_IDEA_BL_F" + "SCH_DISCWDIS_REF_IDEA_BL_M") / (NULLIF("SCH_ENR_BL_F", 0) + NULLIF("SCH_ENR_BL_M", 0)) as BL_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_REF_IDEA_WH_F" + "SCH_DISCWDIS_REF_IDEA_WH_M") / (NULLIF("SCH_ENR_WH_F", 0) + NULLIF("SCH_ENR_WH_M", 0)) as WH_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_REF_IDEA_AM_F" + "SCH_DISCWDIS_REF_IDEA_AM_M") / (NULLIF("SCH_ENR_AM_F", 0) + NULLIF("SCH_ENR_AM_M", 0)) as AM_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_REF_IDEA_AS_F" + "SCH_DISCWDIS_REF_IDEA_AS_M") / (NULLIF("SCH_ENR_AS_F", 0) + NULLIF("SCH_ENR_AS_M", 0)) as AS_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_REF_IDEA_HI_F" + "SCH_DISCWDIS_REF_IDEA_HI_M") / (NULLIF("SCH_ENR_HI_F", 0) + NULLIF("SCH_ENR_HI_M", 0)) as HI_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_REF_IDEA_HP_F" + "SCH_DISCWDIS_REF_IDEA_HP_M") / (NULLIF("SCH_ENR_HP_F", 0) + NULLIF("SCH_ENR_HP_M", 0)) as HP_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_REF_IDEA_TR_F" + "SCH_DISCWDIS_REF_IDEA_TR_M") / (NULLIF("SCH_ENR_TR_F", 0) + NULLIF("SCH_ENR_TR_M", 0)) as TR_both_genders_WDIS_REF_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_BL_F" + "SCH_DISCWDIS_ARR_IDEA_BL_M") / (NULLIF("SCH_ENR_BL_F", 0) + NULLIF("SCH_ENR_BL_M", 0)) as BL_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_WH_F" + "SCH_DISCWDIS_ARR_IDEA_WH_M") / (NULLIF("SCH_ENR_WH_F", 0) + NULLIF("SCH_ENR_WH_M", 0)) as WH_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_AM_F" + "SCH_DISCWDIS_ARR_IDEA_AM_M") / (NULLIF("SCH_ENR_AM_F", 0) + NULLIF("SCH_ENR_AM_M", 0)) as AM_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_AS_F" + "SCH_DISCWDIS_ARR_IDEA_AS_M") / (NULLIF("SCH_ENR_AS_F", 0) + NULLIF("SCH_ENR_AS_M", 0)) as AS_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_HI_F" + "SCH_DISCWDIS_ARR_IDEA_HI_M") / (NULLIF("SCH_ENR_HI_F", 0) + NULLIF("SCH_ENR_HI_M", 0)) as HI_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_HP_F" + "SCH_DISCWDIS_ARR_IDEA_HP_M") / (NULLIF("SCH_ENR_HP_F", 0) + NULLIF("SCH_ENR_HP_M", 0)) as HP_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWDIS_ARR_IDEA_TR_F" + "SCH_DISCWDIS_ARR_IDEA_TR_M") / (NULLIF("SCH_ENR_TR_F", 0) + NULLIF("SCH_ENR_TR_M", 0)) as TR_both_genders_WDIS_ARR_IDEA_rate
...
, ("SCH_DISCWODIS_REF_TR_F" / NULLIF("SCH_ENR_TR_F", 0)) as TR_F_WODIS_REF_rate
, ("SCH_DISCWODIS_REF_TR_F" + "SCH_DISCWODIS_REF_TR_M") / (NULLIF("SCH_ENR_TR_F", 0) + NULLIF("SCH_ENR_TR_M", 0)) as TR_both_genders_WODIS_REF_rate
, ("SCH_DISCWDIS_REF_IDEA_BL_M" / NULLIF("SCH_IDEA_ENR_BL_M", 0)) as BL_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_BL_F" / NULLIF("SCH_IDEA_ENR_BL_F", 0)) as BL_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_BL_F" + "SCH_DISCWDIS_REF_IDEA_BL_M") / (NULLIF("SCH_IDEA_ENR_BL_F", 0) + NULLIF("SCH_IDEA_ENR_BL_M", 0)) as BL_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_WH_M" / NULLIF("SCH_IDEA_ENR_WH_M", 0)) as WH_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_WH_F" / NULLIF("SCH_IDEA_ENR_WH_F", 0)) as WH_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_WH_F" + "SCH_DISCWDIS_REF_IDEA_WH_M") / (NULLIF("SCH_IDEA_ENR_WH_F", 0) + NULLIF("SCH_IDEA_ENR_WH_M", 0)) as WH_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_AM_M" / NULLIF("SCH_IDEA_ENR_AM_M", 0)) as AM_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_AM_F" / NULLIF("SCH_IDEA_ENR_AM_F", 0)) as AM_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_AM_F" + "SCH_DISCWDIS_REF_IDEA_AM_M") / (NULLIF("SCH_IDEA_ENR_AM_F", 0) + NULLIF("SCH_IDEA_ENR_AM_M", 0)) as AM_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_AS_M" / NULLIF("SCH_IDEA_ENR_AS_M", 0)) as AS_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_AS_F" / NULLIF("SCH_IDEA_ENR_AS_F", 0)) as AS_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_AS_F" + "SCH_DISCWDIS_REF_IDEA_AS_M") / (NULLIF("SCH_IDEA_ENR_AS_F", 0) + NULLIF("SCH_IDEA_ENR_AS_M", 0)) as AS_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_HI_M" / NULLIF("SCH_IDEA_ENR_HI_M", 0)) as HI_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_HI_F" / NULLIF("SCH_IDEA_ENR_HI_F", 0)) as HI_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_HI_F" + "SCH_DISCWDIS_REF_IDEA_HI_M") / (NULLIF("SCH_IDEA_ENR_HI_F", 0) + NULLIF("SCH_IDEA_ENR_HI_M", 0)) as HI_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_HP_M" / NULLIF("SCH_IDEA_ENR_HP_M", 0)) as HP_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_HP_F" / NULLIF("SCH_IDEA_ENR_HP_F", 0)) as HP_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_HP_F" + "SCH_DISCWDIS_REF_IDEA_HP_M") / (NULLIF("SCH_IDEA_ENR_HP_F", 0) + NULLIF("SCH_IDEA_ENR_HP_M", 0)) as HP_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_TR_M" / NULLIF("SCH_IDEA_ENR_TR_M", 0)) as TR_M_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_TR_F" / NULLIF("SCH_IDEA_ENR_TR_F", 0)) as TR_F_WDIS_REF_IDEA_rate
, ("SCH_DISCWDIS_REF_IDEA_TR_F" + "SCH_DISCWDIS_REF_IDEA_TR_M") / (NULLIF("SCH_IDEA_ENR_TR_F", 0) + NULLIF("SCH_IDEA_ENR_TR_M", 0)) as TR_both_genders_WDIS_REF_IDEA_rate
, ("SCH_DISCWODIS_ARR_BL_M" / NULLIF("SCH_ENR_BL_M", 0)) as BL_M_WODIS_ARR_rate
, ("SCH_DISCWODIS_ARR_BL_F" / NULLIF("SCH_ENR_BL_F", 0)) as BL_F_WODIS_ARR_rate
, ("SCH_DISCWODIS_ARR_BL_F" + "SCH_DISCWODIS_ARR_BL_M") / (NULLIF("SCH_ENR_BL_F", 0) + NULLIF("SCH_ENR_BL_M", 0)) as BL_both_genders_WODIS_ARR_rate
, ("SCH_DISCWODIS_ARR_WH_M" / NULLIF("SCH_ENR_WH_M", 0)) as WH_M_WODIS_ARR_rate
...
, ("SCH_DISCWODIS_ARR_TR_F" / NULLIF("SCH_ENR_TR_F", 0)) as TR_F_WODIS_ARR_rate
, ("SCH_DISCWODIS_ARR_TR_F" + "SCH_DISCWODIS_ARR_TR_M") / (NULLIF("SCH_ENR_TR_F", 0) + NULLIF("SCH_ENR_TR_M", 0)) as TR_both_genders_WODIS_ARR_rate
, ("SCH_DISCWDIS_ARR_IDEA_BL_M" / NULLIF("SCH_IDEA_ENR_BL_M", 0)) as BL_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_BL_F" / NULLIF("SCH_IDEA_ENR_BL_F", 0)) as BL_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_BL_F" + "SCH_DISCWDIS_ARR_IDEA_BL_M") / (NULLIF("SCH_IDEA_ENR_BL_F", 0) + NULLIF("SCH_IDEA_ENR_BL_M", 0)) as BL_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_WH_M" / NULLIF("SCH_IDEA_ENR_WH_M", 0)) as WH_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_WH_F" / NULLIF("SCH_IDEA_ENR_WH_F", 0)) as WH_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_WH_F" + "SCH_DISCWDIS_ARR_IDEA_WH_M") / (NULLIF("SCH_IDEA_ENR_WH_F", 0) + NULLIF("SCH_IDEA_ENR_WH_M", 0)) as WH_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_AM_M" / NULLIF("SCH_IDEA_ENR_AM_M", 0)) as AM_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_AM_F" / NULLIF("SCH_IDEA_ENR_AM_F", 0)) as AM_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_AM_F" + "SCH_DISCWDIS_ARR_IDEA_AM_M") / (NULLIF("SCH_IDEA_ENR_AM_F", 0) + NULLIF("SCH_IDEA_ENR_AM_M", 0)) as AM_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_AS_M" / NULLIF("SCH_IDEA_ENR_AS_M", 0)) as AS_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_AS_F" / NULLIF("SCH_IDEA_ENR_AS_F", 0)) as AS_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_AS_F" + "SCH_DISCWDIS_ARR_IDEA_AS_M") / (NULLIF("SCH_IDEA_ENR_AS_F", 0) + NULLIF("SCH_IDEA_ENR_AS_M", 0)) as AS_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_HI_M" / NULLIF("SCH_IDEA_ENR_HI_M", 0)) as HI_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_HI_F" / NULLIF("SCH_IDEA_ENR_HI_F", 0)) as HI_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_HI_F" + "SCH_DISCWDIS_ARR_IDEA_HI_M") / (NULLIF("SCH_IDEA_ENR_HI_F", 0) + NULLIF("SCH_IDEA_ENR_HI_M", 0)) as HI_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_HP_M" / NULLIF("SCH_IDEA_ENR_HP_M", 0)) as HP_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_HP_F" / NULLIF("SCH_IDEA_ENR_HP_F", 0)) as HP_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_HP_F" + "SCH_DISCWDIS_ARR_IDEA_HP_M") / (NULLIF("SCH_IDEA_ENR_HP_F", 0) + NULLIF("SCH_IDEA_ENR_HP_M", 0)) as HP_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_TR_M" / NULLIF("SCH_IDEA_ENR_TR_M", 0)) as TR_M_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_TR_F" / NULLIF("SCH_IDEA_ENR_TR_F", 0)) as TR_F_WDIS_ARR_IDEA_rate
, ("SCH_DISCWDIS_ARR_IDEA_TR_F" + "SCH_DISCWDIS_ARR_IDEA_TR_M") / (NULLIF("SCH_IDEA_ENR_TR_F", 0) + NULLIF("SCH_IDEA_ENR_TR_M", 0)) as TR_both_genders_WDIS_ARR_IDEA_rate
, ("SCH_GTENR_BL_M" / NULLIF("SCH_ENR_BL_M", 0)) as BL_M_GTENR_rate
, ("SCH_GTENR_BL_F" / NULLIF("SCH_ENR_BL_F", 0)) as BL_F_GTENR_rate
, ("SCH_GTENR_BL_F" + "SCH_GTENR_BL_M") / (NULLIF("SCH_ENR_BL_F", 0) + NULLIF("SCH_ENR_BL_M", 0)) as BL_both_genders_GTENR_rate
, ("SCH_GTENR_WH_M" / NULLIF("SCH_ENR_WH_M", 0)) as WH_M_GTENR_rate
